...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/register', '/key-usage', '/setup', '/payment/result', '/payment/airwallex', '/legal']
...
const BACKEND_MODE_PENDING_AUTH_PATHS = ['/email-verify']
