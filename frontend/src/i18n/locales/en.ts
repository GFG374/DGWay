  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_apiStyle: 'API Style',
        field_apiStyleHint: 'Standard EasyPay uses pid/pkey/mapi.php; epay.jylt.cc uses mchId/secret/createOrder.',
        ...
        field_secret: 'Communication Secret',
