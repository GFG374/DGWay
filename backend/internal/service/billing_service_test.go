...
func TestGetModelPricing_OpenAICompactAliasesFallback(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "gpt-5.6", inputPrice: 5e-6, outputPrice: 30e-6, cacheRead: 0.5e-6, longContext: 272000},
		{model: "gpt-5.6-terra", inputPrice: 2.5e-6, outputPrice: 15e-6, cacheRead: 0.25e-6, longContext: 272000},
		{model: "gpt-5.6-luna", inputPrice: 1e-6, outputPrice: 6e-6, cacheRead: 0.1e-6, longContext: 272000},
